...
/**
 * Digital vs document applications of one identity. Rendered as two contrasting
 * panels so the difference in treatment is visible, not just described.
 */
export function ApplicationSplit({
  panels,
}: {
  panels: {
    label: string;

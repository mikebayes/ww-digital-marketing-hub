...
import SocialMediaServiceStandards from "./service-onboarding/social-media/service-standards";
import SocialMediaSetupLaunch from "./service-onboarding/social-media/setup-launch";
...
export const modules: Record<string, ComponentType> = {
  ...
  "service-onboarding/social-media/service-standards": SocialMediaServiceStandards,
  "service-onboarding/social-media/setup-launch": SocialMediaSetupLaunch,

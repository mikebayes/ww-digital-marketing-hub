 ...
 * Preview.
 *
 * Runs the internal snapshot through the same projection the public route
 * uses and hands it to the same component, so this is the client's page rather
 * than a drawing of it. If a question is excluded or internal-only, its absence
 ...
 */
export default async function PreviewIntakePage({
  params,
}: {
